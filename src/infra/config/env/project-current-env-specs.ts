...
export const PROJECT_ENV_SPECS: readonly EnvSpec[] = [
  ...
  { path: 'pull_request', type: 'json' },
  { path: 'pull_request.title_template', type: 'string' },
  { path: 'pull_request.body_template', type: 'string' },
  { path: 'pull_request.body_sections', type: 'json' },
